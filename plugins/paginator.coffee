...
module.exports = (env, callback) ->
  ...
  defaults =
    ...
    articles: 'news' # directory containing contents to paginate
    first: 'news/index.html' # filename/url for first page
    filename: 'news/page/%d/index.html' # filename for rest of pages
  ...
  class PaginatorPage extends env.plugins.Page
    ...
    getView: -> (env, locals, contents, templates, callback) ->
      ...
      ctx = {page: this, @articles, @prevPage, @nextPage}
